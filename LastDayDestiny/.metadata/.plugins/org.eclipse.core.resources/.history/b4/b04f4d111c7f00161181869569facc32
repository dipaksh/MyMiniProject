								...
								<table class="form-table" style="width:auto">
									...
									int reviewid1;
    									...
    									try{
											...
											resultset1 =stmt.executeQuery("select reviewtable.index,reviewtable.reviews,booktable.title from booktable,reviewtable where reviewtable.userid='"+id+"' and booktable.bookid=reviewtable.bookid and  reviewtable.index='"+reviewid+"' ");
										...
										<tr>
											...
											<%
												...
												<tr>
														<td>Your Review</td>
														<td>
														<input class="validate[required]" type="text" name="review" value="<%= resultset1.getString(2) %>"></input>
