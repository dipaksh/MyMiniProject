							...
							<div class="padding_20 text-justify">
								<div class="tabs-container">
									<ul class="tabs">
										...
										<li><a href="#tabs-4">Modify Review</a></li>
										<li><a href="#tabs-5">Delete Review</a></li>
									...
									<%
									 int reviewid;
    									try{
											...
											resultset1 =stmt.executeQuery("select reviewtable.index,reviewtable.reviews,booktable.title from booktable,reviewtable where reviewtable.userid='"+id+"' and booktable.bookid=reviewtable.bookid ");
							...
							<form id="frmMain4" class="frmMain" action="#" method="post">
									...
									<%
    									...
    									try{
											...
											resultset1 =stmt.executeQuery("select user.username,booktable.title,reviewtable.reviews from user,booktable,reviewtable where user.userid='"+id+"' and booktable.bookid=reviewtable.bookid ");
