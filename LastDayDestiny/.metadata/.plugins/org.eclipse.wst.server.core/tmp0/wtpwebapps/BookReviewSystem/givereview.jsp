...
<script type="text/javascript">
		...
		{
	     	   var msg = document.getElementById("addreview").value;
						...
						<div class="tabs-container">
							...
							<div class="tabs-contents">
								...
								<div id="tabs-2" style="overflow: auto; max-height: 450px">
									...
									<form id="frmMain2" class="frmMain" action="ReviewServlet"
										method="post">
    									...
    									try{
											...
											%>
												...
												<tr>
													<td>Your Review</td>
													<td><textarea id="addreview"
															class="validate[required]  class="
															validate[maxSize[200]]" style="width: 99%" cols="10"
															rows="3" name="addreview"
															placeholder="Maximum 200 Characters" value=""
															onchange="validateReviewField()"></textarea> <span
														id="errmsg"></span></td>
												</tr>
												<tr>
													<th>&nbsp;</th>
											...
											<table border='0' width='100%' class='table11'>
												...
												<tr>
													...
													<% 
														...
														%>
													<td><a
														href='modifyreview.jsp?reviewid=+<%= reviewid %>+'>Modify</a></td>
													<td><a
														href='deletereview.jsp?reviewid=+<%= reviewid %>+'>Delete</a></td>
