			...
			<div class="contents">
				...
				<div class="grid_18 omega">
					...
					<div class="padding_20 text-justify">
						<form id="frmMain" class="frmMain" action="UpdateReviewServlet"
							method="post">
							...
							<table class="form-table" style="width: auto">
								...
								<table border='0' width='100%' class='table11'>
									<tr>
										<th colspan="2">Modify Your Review</th>
									</tr>
									...
									<tr>
										...
										<td><input class="validate[required]" type="text"
											...
											value="<%= resultset1.getString(2) %>"
											onchange="validateReviewField()"></input> <span id="errmsg"></span>
										</td>
									</tr>
									<tr>
										<th>&nbsp;</th>
										<td><input id="Submit1" type="submit" value="Update" />
