			...
			<div class="contents">
				...
				<div class="grid_18 omega">
					...
					<div class="padding_20 text-justify">
						<form id="frmMain" class="frmMain" action="AdminValidationServlet"
							method="post">
							<table class="form-table" style="width: auto">
								<tr>
									...
									<td><input id="email" type="text"
										...
										placeholder="demo@cybage.com" value="" /></td>
									<td>
										<ul class="news-ticker1">
											<span class="icon">&#9734;</span> Must be Registered
										</ul>
									</td>
